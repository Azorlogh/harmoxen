...
use druid::{
	Application, BoxConstraints, Cursor, Data, Env, FontDescriptor, HotKey, KbKey, KeyOrValue, Selector, SysMods, TimerToken,
};

use druid::kurbo::{Affine, Insets, Point, Size};
use druid::theme;
...
impl Widget<String> for TextBox {
	...
	fn layout(&mut self, _ctx: &mut LayoutCtx, bc: &BoxConstraints, _data: &String, env: &Env) -> Size {
